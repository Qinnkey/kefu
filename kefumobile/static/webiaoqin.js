// 原 swipe.js文件
  ...
  var emoji_data = ["[/::)]==[微笑]", "[/::~]==[撇嘴]", "[/::B]==[色]", "[/::|]==[发呆]", "[/:8-)]==[得意]", "[/::<]==[流泪]", "[/::$]==[害羞]", "[/::X]==[闭嘴]", "[/::Z]==[睡]", "[/::'(]==[大哭]", "[/::-|]==[尴尬]", "[/::@]==[发怒]", "[/::P]==[调皮]", "[/::D]==[呲牙]", "[/::O]==[惊讶]", "[/::(]==[难过]", "[/::+]==[好酷]", "[/:--b]==[囧]", "[/::Q]==[抓狂]", "[/::T]==[吐]", "[/:,@P]==[偷笑]", "[/:,@-D]==[愉快]", "[/::d]==[白眼]", "[/:,@o]==[傲慢]", "[/::g]==[饥饿]", "[/:|-)]==[困]", "[/::!]==[惊恐]", "[/::L]==[流汗]", "[/::>]==[憨笑]", "[/::,@]==[悠闲]", "[/:,@f]==[奋斗]", "[/::-S]==[咒骂]", "[/:?]==[疑问]", "[/:,@x]==[嘘]", "[/:,@@]==[晕]", "[/::8]==[疯了]", "[/:,@!]==[衰]", "[/:!!!]==[骷髅]", "[/:xx]==[敲打]", "[/:bye]==[再见]", "[/:wipe]==[擦汗]", "[/:dig]==[抠鼻]", "[/:handclap]==[鼓掌]", "[/:&-(]==[糗大了]", "[/:B-)]==[坏笑]", "[/:<@]==[左哼哼]", "[/:@>]==[右哼哼]", "[/::-O]==[哈欠]", "[/:>-|]==[鄙视]", "[/:P-(]==[委屈]", "[/::'|]==[快哭了]", "[/:X-)]==[阴险]", "[/::*]==[亲亲]", "[/:@x]==[吓]", "[/:8*]==[可怜]", "[/:pd]==[菜刀]", "[/:<W>]==[西瓜]", "[/:beer]==[啤酒]", "[/:basketb]==[篮球]", "[/:oo]==[乒乓]", "[/:coffee]==[咖啡]", "[/:eat]==[饭]", "[/:pig]==[猪头]", "[/:rose]==[玫瑰]", "[/:fade]==[凋谢]", "[/:showlove]==[嘴唇]", "[/:heart]==[爱心]", "[/:break]==[心碎]", "[/:cake]==[蛋糕]", "[/:li]==[闪电]", "[/:bome]==[炸弹]", "[/:kn]==[刀]", "[/:footb]==[足球]","[/:ladybug]==[瓢虫]","[/:shit]==[便便]","[/:moon]==[月亮]","[/:sun]==[太阳]","[/:gift]==[礼物]","[/:hug]==[拥抱]","[/:strong]==[强]","[/:weak]==[弱]","[/:share]==[握手]","[/:v]==[胜利]","[/:@)]==[抱拳]","[/:jj]==[勾引]","[/:@@]==[拳头]","[/:bad]==[差劲]","[/:lvu]==[爱你]","[/:no]==[NO]","[/:ok]==[OK]","[/:love]==[爱情]","[/:<L>]==[飞吻]","[/:jump]==[跳跳]","[/:shake]==[发抖]","[/:<O>]==[怄火]","[/:circle]==[转圈]","[/:kotow]==[磕头]","[/:turn]==[回头]","[/:skip]==[跳绳]","[/:oY]==[挥手]"].slice(0, -10);
// 原 input.js文件
